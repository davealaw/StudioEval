...
class TestCLIModelSelectionWorkflows:
    ...
    def test_cli_model_listing(self):
        ...
        # CLI should accept --list-models argument parsing (currently
        # unavailable). Use a known-working argument instead.
    ...
    def test_cli_all_models_evaluation(self):
        ...
        # Ensure --all flag is recognized in help without triggering a server
        # connection.
...
class TestCLIOutputWorkflows:
    ...
    def test_cli_custom_output_directory(self, temp_output_dir):
        ...
        # CLI should accept output directory arguments, but --output-dir is not
        # available yet. Use existing arguments instead.
    ...
    def test_cli_verbose_mode(self):
        ...
        result = subprocess.run(
            ["python3", "studioeval.py", "--log-level", "DEBUG", "--help"],
            capture_output=True,
            text=True,
            cwd=".",
        )
    ...
    def test_cli_invalid_model_name(self):
        ...
        result = subprocess.run(
            [
                ...
                "studioeval.py",
                "--model",
                "definitely-not-a-real-model-name-123",
                "--help",
            ],
            capture_output=True,
            text=True,
...
class TestCLIIntegrationScenarios:
    ...
    def realistic_test_setup(self, tmp_path):
        ...
        # Create config file
        config = {"server_url": "http://localhost:1234", "timeout": 30}
    ...
    def test_realistic_evaluation_workflow(self, realistic_test_setup):
        ...
        result = subprocess.run(
            [
                ...
                "studioeval.py",
                "--comm-config",
                realistic_test_setup["config_file"],
                "--datasets-config",
                realistic_test_setup["datasets_file"],
                "--model-filter",
                "qwen*",
                "--help",
            ],
