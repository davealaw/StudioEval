    ...
    def setup(self):
        ...
        grammar_data = [
            ...
            },
            {
                ...
                "options": ["A) I has done it", "B) I have done it", "C) I had did it", "D) I done it"],
                "answer": "B"
            }
        ]
        ...
        logic_data = [
            {
                ...
                "options": ["A) Fluffy is an animal", "B) Fluffy is not an animal", "C) Cannot determine", "D) Fluffy is a dog"],
                "answer": "A"
            },
            {
...
def mock_datasets_config(mock_dataset_files):
    ...
    return {
        ...
        'logic': {
            'file': mock_dataset_files.get_dataset_path('logic'),
            'type': 'json'
        },
        'math': {
            'file': mock_dataset_files.get_dataset_path('math'), 
            'type': 'json'
        }
    }
