...
class TestParamsMerging:
    ...
    def test_merge_eval_kwargs_config_only(self):
        ...
        config = {"seed": 42, "sample_size": 100, "split": "train"}
        ...
        assert result == {"seed": 42, "sample_size": 100, "split": "train"}
    ...
    def test_merge_eval_kwargs_cli_only(self):
        ...
        assert result == {"seed": 123, "sample_size": 50, "split": "test"}
    ...
    def test_merge_eval_kwargs_explicit_cli_overrides_config(self):
        ...
        result = merge_eval_kwargs(
            config, cli_args, ["seed", "sample_size", "split"], cli_explicit_args
        )
    ...
    def test_merge_eval_kwargs_zero_values_preserved(self):
        ...
        result = merge_eval_kwargs(
            config, cli_args, ["seed", "sample_size"], cli_explicit_args
        )
